<x-layout title="Profile">
    ...
    <div class="flex flex-col md:flex-row">
        <div class="md:w-1/3 text-center mb-8 md:mb-0">
            <img src="{{$user->image}}" alt="Profile Picture" class="rounded-full w-48 h-48 mx-auto mb-4 border-4  transition-transform duration-300 hover:scale-105">
            <h1 class="text-2xl font-bold  dark:text-black mb-2">{{$user->name}}</h1>
        </div>
